...
import { useChatThread, useSendChatMessage } from "../queries";
...
export default function ChatFab() {
  ...
  const thread = useChatThread(orderId, POLL.guestChat);
  ...
  async function sendMessage(message: string): Promise<boolean> {
    ...
    try {
      await sendChat.mutateAsync({ orderId, message: message.trim() });
      return true;
    } catch (err) {
